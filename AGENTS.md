...
| `/content/staff`                      | `content-staff`               | answers-pending queue; `meta.requiresAuth` + `requiresStaff`                                                 |
| `/content/staff/requests/:id`         | `content-staff-request`       | answers hub (actionable task-set list; no block UI); `requiresStaff`                                         |
| `/content/staff/requests/:id/tasks`   | `content-staff-request-tasks` | nested tasks → redirect hub after approve; `requiresStaff`                                                   |
...
| `client-locate-change-points` | Where to edit/add (incl. content packs D1′/author delete / live Edit in-collection + trash / `inCollection`; Vitest harness paths)                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `client-work-with-structure`  | pages / components / boot / stores / assets placement (always-button brand logo ≥60px; content live Edit in-collection + trash/click isolation (no row `:to`; hide Edit if `blocked`) / author delete unpublished / D1′ / staff redirect / no block UI)                                                                                                                                                                                                                                                                                                                                             |
| `work-with-forms`             | LoginPage / ForgotPasswordPage / ResetPasswordPage `q-form` / rules                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `work-with-pages`             | Routes + guards; Lobby «Наборы» → collection; content trash + click isolation (no row `:to`; hide Edit if `blocked`); live Edit when `inCollection` (+ pending-author; hide if blocked/foreign pending); author delete unpublished; D1′ lock; staff hub redirect after approve tasks; no block UI; GamePage HUD / board                                                                                                                                                                                                                                                                                                    |
| `work-with-stores`            | Pinia `auth` / `theme` / `game` / `support` / `content` (dual submit + D1′/D5′ locks / live `inCollection` + `pendingAnswersAuthorId`/`pendingTasksAuthorId` / collection trash confirm / author delete unpublished / staff redirect / no block UI)                                                                                                                                                                                                                                                                                                                                              |
...
| `work-with-localization`      | vue-i18n; auth-email RU; `content.*` («Набор карточек» / trash remove confirm / D1′ lock / staff nested + errors); game keys                                                                                                                                                                                                                                                                                                                                                                                                                                 |

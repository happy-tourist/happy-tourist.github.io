...
- Browse content maps («Карты» `/content/maps`): approved in-catalog for any JWT; author’s own never-published drafts; paint editor 10×10 + players×tourists; submit / my-moderation / shared staff queue type badge pack|map; soft-unpublish + staff Edit lock; no collection; not wired into tourist-room create.

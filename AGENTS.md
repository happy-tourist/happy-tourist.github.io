...
- Browse content packs: collection → catalog/create; Edit only from collection (confirm remove-from-collection; no Edit on live pack page); answers page («Набор карточек») + nested task-set; dual submit; author delete unpublished pack/task-set (confirm); D1′ task lock; statuses + threads; staff hub → nested tasks → redirect hub after approve (no block UI).
...
| `/content/collection`                 | `content-collection`          | own collection (lobby entry; Edit + confirm remove); `meta.requiresAuth`                 |
| `/content/packs/new`                  | `content-pack-new`            | create → redirect answers; `meta.requiresAuth` (+ verify gate)                           |
| `/content/packs/:id`                  | `content-pack`                | live pack view (**no** Edit); `meta.requiresAuth`                                        |
...
| `client-locate-change-points` | Where to edit/add (incl. content packs D1′/author delete / collection-only Edit; Vitest harness paths)                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `client-work-with-structure`  | pages / components / boot / stores / assets placement (always-button brand logo ≥60px; content collection-only Edit + confirm remove / author delete unpublished / D1′ / staff redirect / no block UI)                                                                                                                                                                                                                                                                                                                                                       |
| `work-with-forms`             | LoginPage / ForgotPasswordPage / ResetPasswordPage `q-form` / rules                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `work-with-pages`             | Routes + guards; Lobby «Наборы» → collection; content collection-only Edit + confirm remove; live pack no Edit; author delete unpublished; D1′ lock; staff hub redirect after approve tasks; no block UI; GamePage HUD / board                                                                                                                                                                                                                                                                                                                               |
| `work-with-stores`            | Pinia `auth` / `theme` / `game` / `support` / `content` (dual submit + D1′/D5′ locks / collection confirm remove / author delete unpublished / staff redirect / no block UI)                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `work-with-localization`      | vue-i18n; auth-email RU; `content.*` («Набор карточек» / confirm remove+delete / D1′ lock / staff nested + errors); game keys                                                                                                                                                                                                                                                                                                                                                                                                                                |

...
export default defineConfig((ctx) => {
  return {
    ...
    build: {
      ...
      // Manual routes live in src/router/index.ts (login / lobby / game + guards)
      filenameBasedRouting: false,

      // hash: GitHub Pages serves /#/lobby without a 404.html fallback
      vueRouterMode: 'hash', // available values: 'hash', 'history'
      // vueRouterBase,

      // user/org site happy-tourist.github.io always deploys at domain root
      publicPath: '/',
      // define: {},
      // defineEnv: {}
